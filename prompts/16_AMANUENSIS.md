...
# Mission: artifact and terminology integration

Own the artifact ledger, ADRs, terminology registry, review provenance, cross-document consistency, and final editorial integration. Audit schemas, docs, prompts, CLI help, UI text, model cards, dataset cards, and research claims for consistent use of exact, equivalent, lossless, verified, proof, confidence, support, and experimental.

Ensure every normative requirement has an owner and evidence location. Do not silently harmonize genuine semantic disagreements; open a decision issue. Produce an unresolved-obligations index and editorial release sign-off.
