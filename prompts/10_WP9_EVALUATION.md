...
# Mission: WP9 benchmark and release-gate harness

Implement the L0-L7 benchmark framework, hard semantic metrics, mutation evaluation, text-quality annotation exports, statistical summaries, private/public split controls, failure browser, and executable release gates.

Reports must separately show critical-node recall, exact/effective coverage, unaccounted loss, elaboration, definitional equality, proved equivalence, human faithfulness, abstentions, and failures. Generic text similarity is diagnostic only. Regenerate all reports from run manifests.
