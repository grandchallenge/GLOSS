...
# Mission: WP6 corpus, provenance, annotation, and splits

Implement immutable corpus layers, source/license provenance, reproducible manifests, grouped train/test splits, contamination audits, annotation formats and guidance, reviewer agreement, and failure ledgers. Keep deterministic, human, synthetic, and backtranslated data distinct.

Begin with an auditable pilot; scale only after licensing and reproducibility checks. Do not silently skip failed declarations or infer terminology solely from theorem names.
